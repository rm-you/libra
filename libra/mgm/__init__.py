    ...
    [
        ...
        cfg.IntOpt('threads',
         ...
         cfg.StrOpt('nova_admin_auth_url',
                   required=False,
                   secret=True,
                   help='the admin auth URL for the Nova API'),
        cfg.StrOpt('nova_admin_user',
                   required=False,
                   secret=True,
                   help='the admin username for the Nova API'),
        cfg.StrOpt('nova_admin_pass',
                   required=False,
                   secret=True,
                   help='the admin password for the Nova API'),
        cfg.StrOpt('nova_admin_region',
                   required=False,
                   secret=True,
                   help='the admin region to use for the Nova API'),
        cfg.StrOpt('nova_admin_tenant',
                   required=False,
                   secret=True,
                   help='the admin tenant name for the Nova API'),
        cfg.StrOpt('nova_admin_tenant_id',
                   required=False,
                   secret=True,
                   help='the admin tenant ID for the Nova API'),
         cfg.BoolOpt('nova_admin_insecure',
                   default=False,
                   secret=True,
                   help='do not attempt to verify admin Nova/Keystone SSL '
                        'certificates'),
        cfg.StrOpt('nova_admin_bypass_url',
                   required=False,
                   secret=True,
                   help='use a different admin URL to the one supplied by '
                        'the service'),
    ],
    group=mgm_group
)
